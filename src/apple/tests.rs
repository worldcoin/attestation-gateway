...
fn test_verify_initial_attestation_success_real_attestation() {
    ...
    assert_eq!(
        result.key_id,
        "E1ptPsQHfbzGSK0w3duq3vv6SChOYXBYQ6KiZtJPWG0="
    );
}
