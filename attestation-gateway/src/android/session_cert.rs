...
mod tests {
    ...
    #[test]
    fn test_non_canonical_true_boolean() {
        let cert = cert_from_test_b64(
            "",
        );
    ...
    #[test]
    fn test_out_of_order_authorization_list() {
        let cert = cert_from_test_b64(
            "",
        );

        assert!(cert.contains_package_name("com.worldcoin"));
        assert_eq!(cert.os_patch_level(), Some(202606));
    }
}
