// https://source.android.com/docs/security/features/keystore/attestation#attestation-v200

use crate::android::key_description::unordered_set_of_u64::UnorderedSetOfU64;

#[derive(asn1::Asn1Read)]
pub struct KeyDescription200<'a> {
    pub _attestation_version: u64,
    pub attestation_security_level: asn1::Enumerated,
    /// `KeyMint` 2.0 reports `200` here (see Android docs).
...
pub struct AuthorizationList<'a> {
    ...
    #[explicit(203)]
    pub _mgf_digest: Option<asn1::SetOf<'a, u64>>,
    #[explicit(303)]
    pub _rollback_resistance: Option<asn1::Null>,
    #[explicit(305)]
    pub _early_boot_only: Option<asn1::Null>,
    #[explicit(400)]
